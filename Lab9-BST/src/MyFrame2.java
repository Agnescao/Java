...
class MyFrame2 extends JFrame implements ActionListener{
	...
	private JButton b3=new JButton("Search Name");
...
//CONSTRUCTOR
	...
	void visit(Node t,String nm) {
		...
		if(nm.equals(t.name))
		{
			 t1.setText(""+t.readKey());
             t2.setText(""+t.readName());
             t3.setText(""+t.readAge());
		}
	}
	...
	public void actionPerformed(ActionEvent e){
	     ...
	     if (target==b3){
	    	 Node t=tree.head.right;
	    	 String searchNM=t4.getText();
